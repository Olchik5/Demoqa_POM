...
public class WindowsTests extends TestBase {
    ...
    public void newTabTest() {
        ...
        Assert.assertTrue(new BrowserWindowsPage(driver).getTextNewTab().contains("sample"));
    ...
    public void newWindowTest() {
        ...
        Assert.assertTrue(new BrowserWindowsPage(driver).getTextNewWindow().contains("page"));
    }
}
